...
$template_main = <<<EOT
<form id="frm_calendar" style="display:none;" name="frm_calendar" action="http://bodysystems.net/_ferramentas/calendario/services/evo_calendar.php" method="post">
<table width="980">
<tr>
	<td width="250" valign="top">
	<div><img src="http://bodysystems.net/_ferramentas/calendario/images/melhore_sua_busca.png" /></div>
		<div id="treinamento">
			<small>Escolha o calendário</small>
				<select id="tipo_treino" name="tipo_treino">
                    ...
                    <option value="4">Módulo de Certificação</option>
					<option value="13">Iniciação ao Fitness</option>
		...
		<div style="padding-top:15px"><img src="http://bodysystems.net/_ferramentas/calendario/images/bt_encerrados.png" id="bt_encerrados" style="cursor:pointer" /></div>
		<div style="padding-top:15px"><img src="http://bodysystems.net/_ferramentas/calendario/images/frete_gratis.png" id="frete_gratis" /></div>
	</td>
...
<input type="hidden" id="r" name="r" value="$aviso"  />
