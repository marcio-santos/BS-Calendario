$(document).ready(function() {
    ...
    function firstLoad($opt,$treino,$programa,$rede){
        //$.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: url,
            data: {firstLoad:$firstLoad,t:$treino,p:$programa,r:$rede}, // serializes the form's elements.
            dataType: "html" ,
    ...
    $('#view_calendar').click(function(event){
        ...
        $.ajax({
            ...
            beforeSend: function(load) {
                ...
                console.debug($("#frm_calendar").serialize());
